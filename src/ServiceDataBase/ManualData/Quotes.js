const Quotes = [
    {
        id: 1,
        text: "A library is not a luxury, it is a necessity.",
        author: "Isaac Asimov",
    },
    {
        id: 1,
        text: "The library is the people's university.",
...
const RandomQuote = Quotes.map((u, i) => {
    return {
        id: i,
        quote: u.text,
        author: u.author
...
const generateQuote = () =>
    new Promise(resolve => setTimeout(() => resolve(RandomQuote), 1500));
